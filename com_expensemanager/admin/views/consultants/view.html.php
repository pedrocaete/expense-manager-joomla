...
/**
 * View para Lista de Consultores
 * 
 ...
 */
class ExpenseManagerViewConsultants extends JViewLegacy
{
    /**
    ...
    protected function addToolbar()
    {
        ...
        // Título da página
        JToolbarHelper::title(JText::_('COM_EXPENSEMANAGER_CONSULTANTS_MANAGER'), 'users');

        // Botão "Novo" - criar novo consultor
        ...
        if (!empty($this->items))
        {
            ...
            {
                JToolbarHelper::publish('consultants.publish', 'JTOOLBAR_PUBLISH', true);
                JToolbarHelper::unpublish('consultants.unpublish', 'JTOOLBAR_UNPUBLISH', true);
            }

            // Botão "Deletar"
            if ($canDo->get('core.delete'))
            {
                JToolbarHelper::deleteList('JGLOBAL_CONFIRM_DELETE', 'consultants.delete', 'JTOOLBAR_DELETE');
            }
        }
        ...
        JHtmlSidebar::setAction('index.php?option=com_expensemanager&view=consultants');
    ...
    protected function getSortFields()
    {
        return array(
            ...
            'a.name'      => JText::_('COM_EXPENSEMANAGER_CONSULTANT_NAME'),
            'a.email'     => JText::_('COM_EXPENSEMANAGER_CONSULTANT_EMAIL'),
            'a.phone'     => JText::_('COM_EXPENSEMANAGER_CONSULTANT_PHONE'),
