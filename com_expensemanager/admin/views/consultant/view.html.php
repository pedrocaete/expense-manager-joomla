...
/**
 * View para Editar Consultor Individual
 */
class ExpenseManagerViewConsultant extends JViewLegacy
{
    public $item;
    public $form;
    public $state;
    ...
    protected function addToolbar()
    {
        ...
        JToolbarHelper::title(
            JText::_(
                'COM_EXPENSEMANAGER_PAGE_' . ($checkedOut ? 'VIEW_CONSULTANT' : ($isNew ? 'ADD_CONSULTANT' : 'EDIT_CONSULTANT'))
            ),
            'user'
        );
        ...
        if (!$checkedOut && ($canDo->get('core.edit') || ($canDo->get('core.create'))))
        {
            ...
            {
                JToolbarHelper::save2new('consultant.save2new');
            }
        }
        ...
        {
            JToolbarHelper::cancel('consultant.cancel', 'JTOOLBAR_CLOSE');
        }
    }
}