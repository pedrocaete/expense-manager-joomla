...
class ExpenseManagerViewExpenses extends JViewLegacy
{
    ...
    protected function addToolbar()
    {
        ...
        JToolbarHelper::title(JText::_('COM_EXPENSEMANAGER_EXPENSES_MANAGER'), 'folder');
        ...
        if (!empty($this->items))
        {
            ...
            {
                JToolbarHelper::deleteList('JGLOBAL_CONFIRM_DELETE', 'expenses.delete', 'JTOOLBAR_DELETE');
            }
        }
