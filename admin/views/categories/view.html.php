...
class ExpenseManagerViewCategories extends JViewLegacy
{
    ...
    protected function addToolbar()
    {
        ...
        JToolbarHelper::title(JText::_('COM_EXPENSEMANAGER_CATEGORIES_MANAGER'), 'users');
        ...
        if (!empty($this->items))
        {
            ...
            {
                JToolbarHelper::deleteList('JGLOBAL_CONFIRM_DELETE', 'categories.delete', 'JTOOLBAR_DELETE');
            }
        }
