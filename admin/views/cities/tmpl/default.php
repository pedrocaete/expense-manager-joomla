            ...
            <table class="table table-striped" id="cityList">
                <thead>
                    <tr>
                        ...
                        <th class="nowrap">
                            <?php echo JHtml::_('searchtools.sort', 'COM_EXPENSEMANAGER_CITY_NAME', 'a.name', $listDirn, $listOrder); ?>
                        </th>
                        <th class="nowrap">
                            <?php echo JHtml::_('searchtools.sort', 'COM_EXPENSEMANAGER_CITY_STATE', 'a.state', $listDirn, $listOrder); ?>
                        </th>
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <td class="nowrap has-context">
                            <div class="pull-left">
                                ...
                                <?php endif; ?>
                                <?php if ($canEdit) : ?>
                                    <a href="<?php echo JRoute::_('index.php?option=com_expensemanager&task=city.edit&id=' . (int) $item->id); ?>">
